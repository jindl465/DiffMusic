...
if START_EPOCH > 0:
    accelerator.load_state(f'/mnt/storage2/Jin/diffMusic/{LOG_DIR}/{MODEL_NAME}/acc_epoch_{START_EPOCH}/')
...
if not os.path.exists(f'/mnt/storage2/Jin/diffMusic/{LOG_DIR}/{MODEL_NAME}'):
    os.makedirs(f'/mnt/storage2/Jin/diffMusic/{LOG_DIR}/{MODEL_NAME}', exist_ok=True)
...
for epoch in range(start_epoch, EPOCH_NUM):
    ...
    accelerator.save_state(f"/mnt/storage2/Jin/diffMusic/{LOG_DIR}/{MODEL_NAME}/acc_epoch_{epoch}/")
