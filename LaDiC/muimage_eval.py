...
parser.add_argument(
    '--output_dir', default="/mnt/storage2/Jin/diffMusic/result/rola32/", type=str,
...
def main():
    ...
    for index, result in enumerate(tqdm(generated_captions)):
        ...
        generate_music(gt_text, decoder_model, args.music_decoder, music_length, output_music_path1)
        ...
        result_json.append({'image_path':image_path, 'gt_text':gt_text, 'generated_caption':gt_text, 'llm_caption':music_caption})
