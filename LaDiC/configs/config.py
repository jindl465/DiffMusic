...
parser.add_argument('--x_mean', type=str, default='/home/cvmlserver10/Jin/diffMusic/LaDiC/datasets/mean_emb_split.pickle', help='Path to X mean')
parser.add_argument('--x_sigma', type=str, default='/home/cvmlserver10/Jin/diffMusic/LaDiC/datasets/std_emb_split.pickle', help='Path to X sigma')
